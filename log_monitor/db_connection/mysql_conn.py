...
class PymysqlConn(BasePymysqlPool):
    """docstring for PymysqlConn"""
    def __init__(self, section):
        self.config = Config().get_content(section)
        super(PymysqlConn, self).__init__(**self.config)
...
if __name__ == '__main__':
    mysql = MyPymysqlPool("defaultMysql")
    sql_all = "SELECT * FROM log"
    result = mysql.getAll(sql_all)
    print(result)
